...
namespace Manipulation
{
    public static class ManipulatorTask
    {
        ...
        public static double[] MoveManipulatorTo(double x, double y, double angle)
        {
            ...
            double elbow = TriangleTask.GetABAngle(Manipulator.UpperArm, Manipulator.Forearm, distanceFromShoulderToWrist);
            ...
            { // Ошибка, если wristX или wristY бесконечны или naN
                return new[] { double.NaN, double.NaN, double.NaN };
            }
    ...
    public class ManipulatorTask_Tests
    {
        ...
        public const double FullSize = Manipulator.UpperArm + Manipulator.Forearm + Manipulator.Palm;
